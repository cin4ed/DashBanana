...
<template>
    ...
    <DefaultTemplate>
        <div class="mb-5 flex justify-between">
            ...
            <div>
                <Link href="/categories/create" class="btn btn-dark m-1 inline-flex justify-center dark:bg-slate-700 dark:text-slate-300 ">
                                    ...
                                    <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="data-table">
                                        ...
                                        <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                            <tr v-for="(category, index) in categories" :key="index">
                                                ...
                                                <td class="table-td">
                                                    <span class="flex">
                                                        <span class="text-sm text-slate-600 dark:text-slate-300 capitalize">{{ category.name }}</span>
                                                    </span>
                                                </td>
                                                <td class="table-td">{{ new Date(category.created_at).toISOString().slice(0, 10) }}</td>
                                                <td class="table-td" v-if="category.create_author">{{ category.create_author.name }}</td>
